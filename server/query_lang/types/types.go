...
const (
    ANALYZE_VARIABLES_PARTS_ANALYZE_OPTIONS_FILTER = 0b00000000
    ANALYZE_VARIABLES_PARTS_ANALYZE_OPTIONS_JOIN = 0b00000001
    ANALYZE_VARIABLES_PARTS_ANALYZE_OPTIONS_LIST = 0b00000000
    ANALYZE_VARIABLES_PARTS_ANALYZE_OPTIONS_NOT_LIST = 0b00000010
    ANALYZE_VARIABLES_PARTS_ANALYZE_OPTIONS_FIX = 0b00000000
    ANALYZE_VARIABLES_PARTS_ANALYZE_OPTIONS_DONT_FIX = 0b00000100
    ANALYZE_VARIABLES_PARTS_ANALYZE_OPTIONS_VALIDATE_VARIABLE = 0b00001000
    ANALYZE_VARIABLES_PARTS_ANALYZE_OPTIONS_DONT_VALIDATE_VARIABLE = 0b00000000
)
