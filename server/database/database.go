...
type Database interface {
    ...
    RunUserCustomQuery(collection_name string, fields []string, filter_tokens []querylang_types.Token, sort_by string, analyzed_expand []querylang_types.TokenValueVariable, used_collections_filters map[string]string) (resJson string, err error)
