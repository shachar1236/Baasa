...
type Database interface {
    ...
    RunUserCustomQuery(collection_name string, fields []string, filter_tokens []types.Token, sort_by string, expand string, used_collections_filters []string, ) (resJson string, err error)
