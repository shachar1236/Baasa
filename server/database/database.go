...
type Database interface {
    ...
    RunUserCustomQuery(collection_name string, fields []string, filter_tokens []querylang_types.Token, sort_by []string, analyzed_SortBy []querylang_types.TokenValueVariable, analyzed_expand []querylang_types.TokenValueVariable, limit int, offset int, used_collections_filters map[string]string) (resJson []byte, err error)
