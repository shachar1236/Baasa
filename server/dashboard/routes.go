...
func addRoutes(mux *http.ServeMux, logger *slog.Logger, admin_exists *bool, admin_session *string) {
    ...
    mux.Handle("POST /register", adminDosentExists(handleRegisterPost(logger, admin_exists, admin_session)))
    mux.Handle("POST /login", guestOnly(handleLoginPost(logger)))
...
func handleRegisterPost(logger *slog.Logger, admin_exists *bool, admin_session *string) http.HandlerFunc {
	return http.HandlerFunc(
		func(w http.ResponseWriter, r *http.Request) {
...
func handleLoginPost(logger *slog.Logger) http.HandlerFunc {
	return http.HandlerFunc(
		func(w http.ResponseWriter, r *http.Request) {
            logger.Info("Logging...")
